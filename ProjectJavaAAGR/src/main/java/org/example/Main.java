...
public class Main {
    public static void main(String[] args) {
       ...
       /*
        ...
        numero1=escanner.nextDouble();
        System.out.println("Escribe el segundo numero");
        numero2=escanner.nextDouble();
        System.out.println("Escribe el tercer numero");
        numero3=escanner.nextDouble();
        System.out.println("Escribe el cuarto numero");
        numero4=escanner.nextDouble();
            ...
            if(numero2>numero1&&numero2>numero3 && numero2>numero4){
                ...
                if (numero3>numero1 && numero3>numero2 && numero3>numero4){
                    ...
                    if (numero4>numero1 && numero4>numero2 && numero4>numero3){
                        System.out.println("el numero 4 es el mayor");
                    }
                    else{
